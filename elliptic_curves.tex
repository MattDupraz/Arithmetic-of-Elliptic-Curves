...
In what follows, we suppose $\chr(K) \not\in \{2, 3\}$.

We can simplify (\ref{weierstrass-eq}) with linear
changes of variables. First notice that
...
\end{equation}
Next, we can also get rid of the term in 
$Y^2$ with a linear change
...
We have that an elliptic curve $V \subset \proj_2$
