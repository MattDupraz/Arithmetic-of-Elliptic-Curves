...
\begin{lemma}
	\begin{enumerate}[label=(\alph*)]
		...
		\item For all $z \in \C\setminus \Lambda$
			\begin{equation*}
				\frac{d^2}{d^2}\log\sigma(z) = -\wp(z)
			\end{equation*}
		\item For any $\omega \in \Lambda$, there are constants
...
\begin{proof}	
	\begin{enumerate}[label=(\alph*)]
		\item We have that for all $z \in \C\setminus \Lambda$ and
			$\lambda \in \Lambda\setminus 0$
			such that $|\frac{z}{\lambda}| < \frac{2}{3}$,
			...
			\begin{align*}
				...
				&\leq \frac{1}{3}\left|\frac{z}{\lambda}\right|^3
				\sum_{k = 0}^\infty\left|\frac{z}{\lambda}\right|^k\\
				\left(\textrm{since $|\frac{z}{\lambda}| \leq \frac{2}{3}$}
				\right)\qquad
				&= \frac{1}{3}\left|\frac{z}{\lambda}\right|^3
				\left(1 - \left|\frac{z}{\lambda}\right|\right)^{-1}\\
				&\leq \left|\frac{z}{\lambda}\right|^3
			\end{align*}
			...
			\begin{equation*}
				...
				\frac{z}{\lambda}\right)^2\right|
			\end{equation*}
			converges absolutely and uniformly on any compact subset of $\C$
